...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Owner 3 mock model inference.")
    parser.add_argument("--manifest", required=True, type=Path, help="Owner 1 manifest CSV.")
    parser.add_argument("--model", required=True, choices=sorted(PROFILES), help="Mock model profile.")
